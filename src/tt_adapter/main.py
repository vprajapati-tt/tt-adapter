    ...
    def convert(self, model_path: str, settings: Dict) -> ModelExplorerGraphs:
        ...
        with ir.Context() as ctx:
            ...
            for op in module.body.operations:
                ...
                graph.nodes.append(
                    graph_builder.GraphNode(id=id, label=get_name(op.name))
                )
                    ...
                    for block in region.blocks:
                        for op in block.operations:
                            ...
                            for ops in op.operands:
                                ...
                                if (
                                    hasattr(ops.type, "encoding")
                                    and ops.type.encoding is None
                                ):
                                    source_node_attrs = [
                                    ...
                                    source_node_attrs = [
                                        ...
                                        graph_builder.KeyValue(
                                            key="Grid Shape",
                                            value=array_ref_repr(
                                                layout.grid_attr.shape
                                            ),
                                        ),
                                    ]
